const readingsData = {
    ...
    'sl_seg_w2': {
        title: 'Salmo Responsorial — Sl 77(78)',
        day: 'Segunda-feira (14/09) — Exaltação da Santa Cruz',
    ...
    '1l_ter_w2': {
        title: '1ª Leitura — Hebreus 5,7-9',
    ...
    'sl_ter_w2': {
        title: 'Salmo Responsorial — Sl 30(31)',
        day: 'Terça-feira (15/09) — Nossa Senhora das Dores',
    ...
    '1l_qui_w2': {
        title: '1ª Leitura — 1 Coríntios 15,1-11',
        day: 'Quinta-feira (17/09) — 24ª Semana do Tempo Comum',
        text: `Leitura da Primeira Carta de São Paulo aos Coríntios 15,1-11\n\nIrmãos: Quero lembrar-vos o evangelho que vos preguei e que recebestes, e no qual estais firmes.\nCom efeito, transmiti-vos, em primeiro lugar, aquilo que eu mesmo tinha recebido, a saber: que Cristo morreu por nossos pecados, segundo as Escrituras; que foi sepultado; que, ao terceiro dia, ressuscitou, segundo as Escrituras; e que apareceu a Cefas e, depois, aos Doze.\n\nMais tarde, apareceu a mais de quinhentos irmãos, de uma vez. Destes, a maioria ainda vive e alguns já morreram. Depois, apareceu a Tiago e, depois, apareceu aos apóstolos todos juntos. Por último, apareceu também a mim, como a um abortivo.\n\nNa verdade, eu sou o menor dos apóstolos, nem mereço o nome de apóstolo, porque persegui a Igreja de Deus. É pela graça de Deus que eu sou o que sou. Sua graça para comigo não foi estéril: a prova é que tenho trabalhado mais do que os outros apóstolos – não propriamente eu, mas a graça de Deus comigo.\n\nÉ isso, em resumo, o que eu e eles temos pregado e é isso o que crestes.\n\nPalavra do Senhor.\nR. Graças a Deus.`
    },
    'sl_qui_w2': {
        title: 'Salmo Responsorial — Sl 117 (118)',
        day: 'Quinta-feira (17/09) — 24ª Semana do Tempo Comum',
    ...
    '1l_dom_w2': {
        title: '1ª Leitura — Isaías 55,6-9',
    ...
    'sl_dom_w2': {
        title: 'Salmo Responsorial — Sl 144(145)',
        day: 'Domingo (20/09) — 25º Domingo do Tempo Comum',
    ...
    '2l_dom_w2': {
        title: '2ª Leitura — Filipenses 1,20c-24.27a',
        day: 'Domingo (20/09) — 25º Domingo do Tempo Comum',
        text: `Leitura da Carta de São Paulo aos Filipenses 1,20c-24.27a\n\nIrmãos: Cristo vai ser glorificado no meu corpo, seja pela minha vida, seja pela minha morte. Pois, para mim, o viver é Cristo e o morrer é lucro.\n\nEntretanto, se o viver na carne significa que meu trabalho será frutuoso, neste caso, não sei o que escolher. Sinto-me atraído para os dois lados: tenho o desejo de partir, para estar com Cristo — o que para mim seria de longe o melhor — mas para vós é mais necessário que eu continue minha vida neste mundo.\n\nSó uma coisa importa: vivei à altura do Evangelho de Cristo.\n\nPalavra do Senhor.\nR. Graças a Deus.`
    },
    'ev_dom_w2': {
